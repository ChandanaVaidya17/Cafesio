...
<section class="our_qualities" id="qualities" style="padding:100px 0px;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row">
			<div class="col-lg-6 sm-padding">
				<div class="contact-info">
					...
					<h3>
						Kalsanka, Opp. D-Mart, Udupi
					</h3>
					<h4>
						<span>Email:</span>
						burger.udupi@gmail.com
						<br>
						<span>Phone:</span>
						+91 8012477405
					</h4>
...
<section class="widget_section" id="about" style="background-color: #222227;padding: 100px 0;">
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="footer_widget">
					...
					<p>
						Our Restaurnt is one of the bests, provide tasty Burgers and Fries. You can reserve a table or Order food.
					</p>
